...
const Sobre = () => {
  return (
    <div>
        ...
        <h2>A MELHOR ESCOLA DE ENSINO TÉCNICO DA AMERICA LATINA!</h2>
        <p>o Senai ES segue sua missão de qualificar profissionais para a indústria, 
            oferecendo cursos, consultorias e serviços que atendem às demandas de um mercado em constante evolução.
        </p>
        </div>
